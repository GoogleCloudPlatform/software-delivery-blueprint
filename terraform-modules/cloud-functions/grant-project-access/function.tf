...
data "archive_file" "source" {
  type        = "zip"
  source_dir  = "${path.module}/../src/provide-project-permissions"
  output_path = "/tmp/project/function.zip"
}
...
resource "google_cloudfunctions_function" "function" {
  ...
  service_account_email = data.google_secret_manager_secret_version.function-sa.secret_data
