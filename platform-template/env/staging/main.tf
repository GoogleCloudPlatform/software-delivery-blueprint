...
locals {
  ...
  gke_cluster_id = format("projects/%s/locations/%s/clusters/%s",var.project_id,module.create_gke_1.cluster_name.location,module.create_gke_1.cluster_name.name)
}
